              ...
              <div className="right-footer-block">
                ...
                <div className="right-footer-blocks">
                  <div className="footer-block">
                    ...
                    <div className="footer-link">
                      <a
                        href="https://docs.google.com/document/u/1/d/1n3YFR3e9NIlx8i1dfuaJxiDnVTGY8pQdg7hLGjvymT0/edit"
                        target={"_blank"}
                      >
                        Privacy
                      </a>
                  ...
                  <div className="footer-block">
                    <div className="footer-link">
                      <a
                        href="https://docs.google.com/document/u/1/d/1X8ixX4C9jT-L7mNqKgbQb_AMA43yLyTWhcXJxP749ts/edit"
                        target={"_blank"}
                      >
                        Terms
                      </a>
                    ...
                    <div className="footer-link">
                      <a
                        href="https://docs.google.com/document/u/1/d/1iiP3L_AhYmlpM-cgB0g9cghjWITGMhXU1AHxco02v_Q/edit"
                        target={"_blank"}
                      >
                        Imprint
                      </a>
